...
class TestUsecase6():
  ...
  def test_usecase6(self):
    ...
    self.driver.find_element(By.ID, "id_timedurationminutes").send_keys("120")
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".dimmed_text").text == "Monday, 11 November, 8:00 AM » 10:00 AM"
