...
class TestUsecase12():
  ...
  def test_usecase12(self):
    ...
    assert self.driver.find_element(By.ID, "fgroup_id_error_durationgroup").text == "The date and time you selected for duration until is before the start time of the event. Please correct this before proceeding."
    dropdown = self.driver.find_element(By.ID, "id_timedurationuntil_day")
    dropdown.find_element(By.XPATH, "//option[. = '11']").click()
    self.driver.find_element(By.ID, "id_timedurationuntil_month").click()
    self.driver.find_element(By.ID, "id_timedurationuntil_year").click()
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".dimmed_text").text == "Monday, 11 November, 8:00 AM » 9:00 AM"
